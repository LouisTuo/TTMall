 ...
 * Generated at: 2017-11-16 13:47:28 UTC
...
public final class content_002dcategory_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("        \t\t// 新增节点\r\n");
      out.write("        \t\tvar jsonObj = {parentId:node.parentId,name:node.text};\r\n");
      out.write("        \t\t/* $.post(\"/content/category/create\",JSON.stringify(jsonObj),function(data){\r\n");
      ...
      out.write("        \t\t}); */\r\n");
      out.write("        \t\t$.ajax({\r\n");
      out.write("        \t\t\turl:\"/content/category/create\",\r\n");
      out.write("        \t\t\ttype:\"POST\",\r\n");
      out.write("        \t\t\tdata:JSON.stringify(jsonObj),\r\n");
      out.write("        \t\t\tdataType : \"JSON\",\r\n");
      out.write("        \t\t\tcontentType:\"application/json\",\r\n");
      out.write("        \t\t\tsuccesss:function(data){\r\n");
      out.write("        \t\t\t\tconsole.log(data);\r\n");
      out.write("            \t\t\tif(data.status == 200){\r\n");
      out.write("            \t\t\t\t_tree.tree(\"update\",{\r\n");
      out.write("                \t\t\t\ttarget : node.target,\r\n");
